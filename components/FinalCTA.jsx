                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="relative z-10 cursor-pointer">Join the Waitlist</span>
                ...
                >
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                            <div className="font-semibold text-sm text-foreground">TeachPlan is ready! 🎉</div>
                            <div className="text-xs text-muted-foreground">Your planning tool awaits</div>
                        </div>
                    </div>
                </motion.div>
            </motion.div>
